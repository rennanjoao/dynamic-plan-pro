-- Biblioteca de templates: "Dieta" e "Periodização" isolados
...
COMMENT ON COLUMN public.protocols.template_kind IS
  'Só tem sentido quando is_template = true. "protocol" = protocolo completo. "workout" = bloco de treino. "diet" = bloco de dieta. "periodization" = bloco de periodização.';
