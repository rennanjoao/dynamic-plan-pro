...
export const TACO_FOODS: TacoFood[] = [
  ...
  { name: "Feijão carioca (cru)",            kcal: 328, p: 20.0, c: 61.2, g: 1.3, group: "carb", cookFactor: 3.0 },
  { name: "Feijão carioca (cozido)",         kcal: 76,  p: 4.8,  c: 13.6, g: 0.5, group: "carb", valuesArCooked: true },
  { name: "Feijão preto (cru)",              kcal: 324, p: 21.2, c: 60.1, g: 1.2, group: "carb", cookFactor: 3.0 },
  ...
  { name: "Patinho (cru)",                   kcal: 133, p: 21.7, c: 0.0,  g: 5.0,  group: "protein", cookFactor: 0.70 },
  { name: "Patinho (moído/cozido)",          kcal: 190, p: 31.0, c: 0.0,  g: 7.1,  group: "protein", valuesArCooked: true },
  ...
  { name: "Alcatra (grelhada)",              kcal: 191, p: 28.9, c: 0.0,  g: 8.1,  group: "protein", valuesArCooked: true },
  { name: "Coxão mole (cru)",                kcal: 137, p: 22.0, c: 0.0,  g: 5.4,  group: "protein", cookFactor: 0.70 },
  { name: "Coxão mole (cozido)",             kcal: 195, p: 31.4, c: 0.0,  g: 7.7,  group: "protein", valuesArCooked: true },
  { name: "Coxão duro (cru)",                kcal: 131, p: 21.8, c: 0.0,  g: 4.7,  group: "protein", cookFactor: 0.68 },
  { name: "Coxão duro (cozido)",             kcal: 193, p: 32.1, c: 0.0,  g: 6.9,  group: "protein", valuesArCooked: true },
  { name: "Lagarto (cru)",                   kcal: 128, p: 21.5, c: 0.0,  g: 4.5,  group: "protein", cookFactor: 0.68 },
  { name: "Lagarto (cozido)",                kcal: 188, p: 31.6, c: 0.0,  g: 6.6,  group: "protein", valuesArCooked: true },
  ...
  { name: "Sardinha fresca (crua)",          kcal: 124, p: 21.5, c: 0.0,  g: 4.2,  group: "protein", cookFactor: 0.80 },
