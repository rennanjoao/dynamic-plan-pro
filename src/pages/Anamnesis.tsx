    ...
    (async () => {
      try {
        ...
        if (isEditMode && existing?.submitted_at) {
          ...
          for (const key of ["meta_prioridade","nivel_treino","tem_academia","pump","hidratacao","compulsao_estado","fezes","acorda_descansado","usa_hormonio_atualmente","ciclo_regular","erecao_matinal","queda_masc","hist_pai","hist_avo_mat"]) {
      ...
      <div className="max-w-xl mx-auto px-4 py-8 space-y-8 relative z-10">
        ...
        <section>
          ...
          <Card>
            ...
            <Field label="Usa hormônio/anabolizante atualmente?">
              <Choices cols={2} group="usa_hormonio_atualmente" state={groups} setState={setGroups} options={[{ value: "Sim" }, { value: "Não", theme: "green" }]} />
            </Field>
